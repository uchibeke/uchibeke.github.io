...
function($scope, $http, $timeout, analytics) {
	$http.get('js/old_data.json').success(function(data) {
		...
		var str1 = ` Hi Melody, I made this to express how I feel about you.***
		<br/><br/> **<br/> You fill up my senses like a night in the forest, like the mountains in springtime, like a walk in the rain,
