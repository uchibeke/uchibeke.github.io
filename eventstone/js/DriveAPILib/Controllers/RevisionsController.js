...
'use strict';
angular.module('DriveAPILib').factory('RevisionsController',function($q,Configuration,HttpClient,APIHelper){
    return{
        /**
         * Removes a revision.
         * @param {string} fileId    Required parameter: The ID of the file.
         * @param {string} revisionId    Required parameter: The ID of the revision.
         ...
         * @return {promise<void>}
         */
        mdelete : function(fileId, revisionId, alt, fields, key, oauthToken, prettyPrint, quotaUser, userIp){
            ...
            var queryBuilder = baseUri + "/files/{fileId}/revisions/{revisionId}";
         ...
         */
        get : function(fileId, revisionId, alt, fields, key, oauthToken, prettyPrint, quotaUser, userIp){
            //Assign default values
            alt = alt || "json";
            prettyPrint = prettyPrint || true;
        ...
        list : function(fileId, alt, fields, key, oauthToken, prettyPrint, quotaUser, userIp){
            ...
            //prepare query string for API call
            var baseUri = Configuration.BASEURI
            var queryBuilder = baseUri + "/files/{fileId}/revisions";
         ...
         * @param {string} revisionId    Required parameter: The ID for the revision.
         * @param {string|null} alt    Optional parameter: Data format for the response. (Acceptable values are: "json")
         * @param {string|null} fields    Optional parameter: Selector specifying which fields to include in a partial response.
         * @param {string|null} key    Optional parameter: API key. Your API key identifies your project and provides you with API access, quota, and reports. Required unless you provide an OAuth 2.0 token.
         * @param {string|null} oauthToken    Optional parameter: OAuth 2.0 token for the current user.
         ...
         * @return {promise<Revision>}
         */
        patch : function(fileId, revisionId, alt, fields, key, oauthToken, prettyPrint, quotaUser, userIp){
            //Assign default values
            alt = alt || "json";
            prettyPrint = prettyPrint || true;
         ...
         * @return {promise<Revision>}
         */
        update : function(fileId, revisionId, alt, fields, key, oauthToken, prettyPrint, quotaUser, userIp){
            //Assign default values
            alt = alt || "json";
            prettyPrint = prettyPrint || true;
